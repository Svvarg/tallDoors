...
//				ySize - 96 + 2, 9919952);
		...
		fontRendererObj.drawString("Fence: " + planks * 2, 90, 15, 9919952);//old Planks 90<-117
		fontRendererObj.drawString("LuiviteIngot: " + iron, 90, 25, 9919952);//old iron
		fontRendererObj.drawString("Wool: " + wool, 90, 35, 9919952);
