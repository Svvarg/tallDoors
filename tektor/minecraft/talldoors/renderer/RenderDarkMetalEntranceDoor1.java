...
public class RenderDarkMetalEntranceDoor1 extends Render{
	public RenderDarkMetalEntranceDoor1() {
	...
	public void doRender(Entity entity, double x, double y, double z, float f,
		...
		int orientation = ((DarkMetalEntranceDoor1) entity).orientation;
		int pos = ((DarkMetalEntranceDoor1) entity).pos;
		boolean left = ((DarkMetalEntranceDoor1) entity).left;
