	...
	public void generate(Random random, int chunkX, int chunkZ, World world,
		...
		if(TallDoorsBase.spawnLuivite)
		{
			for (int k = 0; k < 8; k++) {
				...
				(new WorldGenMinable(TallDoorsBase.iconoStone.blockID,0,23, Block.stone.blockID)).generate(
				world, random, firstBlockXCoord, firstBlockYCoord,
				firstBlockZCoord);
				(new WorldGenMinable(TallDoorsBase.luiviteOre.blockID,0,7, TallDoorsBase.iconoStone.blockID)).generate(
						world, random, firstBlockXCoord, firstBlockYCoord,
						firstBlockZCoord);
				}
		}
