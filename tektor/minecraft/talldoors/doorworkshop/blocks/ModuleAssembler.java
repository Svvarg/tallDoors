...
public class ModuleAssembler extends BlockContainer{
	...
	public ModuleAssembler(int blockID8) {
		super(blockID8,Material.iron);
		setHardness(4.2F);
		setResistance(5.0F);
		this.setUnlocalizedName("moduleAssemler");
	...
	@Override
	public void breakBlock(World world, int x, int y, int z, int par5,
			int par6) {
