...
public class NailedPlainPartType extends AbstractDoorPartType{
	...
	public void initialize() {
		...
		entityClass = NailedPlainPartEntity.class;
		textureCount = 2;
	}
	...
	public AbstractDoorPart getNewEntity(World world, double posX, int heightPosition, double posZ, int heightSize, int orientation) {
		AbstractDoorPart part = new NailedPlainPartEntity(world, posX, heightPosition, posZ, heightSize, orientation,depth);
		return part;
	}
