...
public class WatchmanWindowRenderer extends AbstractModuleDoorRenderer {
	...
	private void drawOpening(WatchmanWindowEntity ent, Tessellator tess) {
		...
		if(ent.watchmanWindow)
		{
			...
			//front
			tess.addVertexWithUV(0.125, 0.126, depth, 0, 0);
			tess.addVertexWithUV(0.125, 0.126, depth + 0.75, 1, 0);
			tess.addVertexWithUV(0.125, 0.874, depth + 0.75, 1, 1);
			tess.addVertexWithUV(0.125, 0.874, depth, 0, 1);
			//back
			tess.addVertexWithUV(0.125+depth, 0.126, depth, 0, 0);
			tess.addVertexWithUV(0.125+depth, 0.874, depth, 0, 1);
			tess.addVertexWithUV(0.125+depth, 0.874, depth + 0.75, 1, 1);
			tess.addVertexWithUV(0.125+depth, 0.126, depth + 0.75, 1, 0);
		...
		else
		{
			...
			//front
			tess.addVertexWithUV(0.125, 0.126, depth, 0, 0);
			tess.addVertexWithUV(0.874, 0.126, depth, 1, 0);
			tess.addVertexWithUV(0.874, 0.874, depth, 1, 1);
			tess.addVertexWithUV(0.125, 0.874, depth, 0, 1);
			
			//back
			tess.addVertexWithUV(0.125, 0.126, 0, 0, 0);
			tess.addVertexWithUV(0.125, 0.874, 0, 0, 1);
			tess.addVertexWithUV(0.874, 0.874, 0, 1, 1);
			tess.addVertexWithUV(0.874, 0.126, 0, 1, 0);
