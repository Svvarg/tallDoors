...
public class GlassWindowPartRenderer extends AbstractModuleDoorRenderer {
	...
	private void drawGlass(GlassWindowPartEntity ent, Tessellator tess) {
		...
		// left bottom front
		tess.addVertexWithUV(0.125, 0.125, depthH + 0.01, 1, 1);
		tess.addVertexWithUV(0.4375, 0.125, depthH + 0.01, 1, 0);
		tess.addVertexWithUV(0.4375, 0.4375, depthH + 0.01, 0, 0);
		tess.addVertexWithUV(0.125, 0.4375, depthH + 0.01, 0, 1);
		// left bottom back
		tess.addVertexWithUV(0.125, 0.125, depthH - 0.01, 1, 1);
		tess.addVertexWithUV(0.125, 0.4375, depthH - 0.01, 0, 1);
		tess.addVertexWithUV(0.4375, 0.4375, depthH - 0.01, 0, 0);
		tess.addVertexWithUV(0.4375, 0.125, depthH - 0.01, 1, 0);
		// left top front
		tess.addVertexWithUV(0.125, 0.5625, depthH + 0.01, 1, 1);
		tess.addVertexWithUV(0.4375, 0.5625, depthH + 0.01, 1, 0);
		tess.addVertexWithUV(0.4375, 0.875, depthH + 0.01, 0, 0);
		tess.addVertexWithUV(0.125, 0.875, depthH + 0.01, 0, 1);
		// left top back
		tess.addVertexWithUV(0.125, 0.5625, depthH - 0.01, 1, 1);
		tess.addVertexWithUV(0.125, 0.875, depthH - 0.01, 0, 1);
		tess.addVertexWithUV(0.4375, 0.875, depthH - 0.01, 0, 0);
		tess.addVertexWithUV(0.4375, 0.5625, depthH - 0.01, 1, 0);
		// right bottom front
		tess.addVertexWithUV(0.5625, 0.125, depthH + 0.01, 1, 1);
		tess.addVertexWithUV(0.875, 0.125, depthH + 0.01, 1, 0);
		tess.addVertexWithUV(0.875, 0.4375, depthH + 0.01, 0, 0);
		tess.addVertexWithUV(0.5625, 0.4375, depthH + 0.01, 0, 1);
		// right bottom back
		tess.addVertexWithUV(0.5625, 0.125, depthH - 0.01, 1, 1);
		tess.addVertexWithUV(0.5625, 0.4375, depthH - 0.01, 0, 1);
		tess.addVertexWithUV(0.875, 0.4375, depthH - 0.01, 0, 0);
		tess.addVertexWithUV(0.875, 0.125, depthH - 0.01, 1, 0);
		// right top front
		tess.addVertexWithUV(0.5625, 0.5625, depthH + 0.01, 1, 1);
		tess.addVertexWithUV(0.875, 0.5625, depthH + 0.01, 1, 0);
		tess.addVertexWithUV(0.875, 0.875, depthH + 0.01, 0, 0);
		tess.addVertexWithUV(0.5625, 0.875, depthH + 0.01, 0, 1);
		// right top back
		tess.addVertexWithUV(0.5625, 0.5625, depthH - 0.01, 1, 1);
		tess.addVertexWithUV(0.5625, 0.875, depthH - 0.01, 0, 1);
		tess.addVertexWithUV(0.875, 0.875, depthH - 0.01, 0, 0);
