...
public class HorHalfedGlassWindowPartRenderer extends AbstractModuleDoorRenderer {
	@Override
	...
	protected void renderingStuff(Entity entity, double x, double y, double z,
			float var8, float var9) {
		HorHalfedGlassWindowPartEntity ent = (HorHalfedGlassWindowPartEntity) entity;
	...
	private void drawGlass(HorHalfedGlassWindowPartEntity ent, Tessellator tess) {
		this.bindTexture(new ResourceLocation(DoorPartRegistry.texturePaths
				.get(ent.texture2)));
	...
	private void drawWindow(AbstractDoorPart ent, Tessellator tess) {
		...
		// middle
		tess.addVertexWithUV(0.125, 0.4375, depth, 0.125, 0.4375);
		tess.addVertexWithUV(0.875, 0.4375, depth, 0.875, 0.4375);
		tess.addVertexWithUV(0.125, 0.5625, depth, 0.125, 0.5625);
		tess.addVertexWithUV(0.875, 0.5625, depth, 0.875, 0.5625);
		...
		// middle
		tess.addVertexWithUV(0.125, 0.4375, 0, 0.125, 0.4375);
		tess.addVertexWithUV(0.875, 0.5625, 0, 0.875, 0.5625);
		tess.addVertexWithUV(0.125, 0.5625, 0, 0.125, 0.5625);
		tess.addVertexWithUV(0.875, 0.4375, 0, 0.875, 0.4375);
		...
		// middle top
		tess.addVertexWithUV(0.125, 0.5625, depth, 0.125, depth + 0.125);
		tess.addVertexWithUV(0.875, 0.5625, depth, 0.875, depth + 0.125);
		tess.addVertexWithUV(0.875, 0.5625, 0, 0.875, 0.125);
		tess.addVertexWithUV(0.125, 0.5625, 0, 0.125, 0.125);

		// middle right
		tess.addVertexWithUV(0.125, 0.4375, depth, 0.125, depth + 0.125);
		tess.addVertexWithUV(0.125, 0.4375, 0, 0.125, 0.125);
		tess.addVertexWithUV(0.875, 0.4375, 0, 0.875, 0.125);
		tess.addVertexWithUV(0.875, 0.4375, depth, 0.875, depth + 0.125);
