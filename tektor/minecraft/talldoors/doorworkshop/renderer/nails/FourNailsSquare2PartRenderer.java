...
public class FourNailsSquare2PartRenderer extends AbstractModuleDoorRenderer{
	...
	protected void renderingStuff(Entity entity, double x, double y, double z,
		...
		FourNailsSquare2PartEntity ent = (FourNailsSquare2PartEntity) entity;
	...
	private void drawNails(FourNailsSquare2PartEntity ent, Tessellator tess) {
	...
	private void drawNailAt(Tessellator tess, double posW, double posH, FourNailsSquare2PartEntity ent)
	{
