...
public class HorizontalBalkPartRenderer extends Render{
	...
	public void doRender(Entity entity, double x, double y, double z,
		...
		int orientation = ((HorizontalBalkPartEntity) entity).orientation;
		int pos = ((HorizontalBalkPartEntity) entity).pos;
